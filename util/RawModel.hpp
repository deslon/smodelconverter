...
struct RawTraditionalMatProps : RawMatProps {
    RawTraditionalMatProps(
        ...
        const FbxVector4 &ambientFactor,
        const FbxVector4 &diffuseFactor,
        const FbxVector4 &emissiveFactor,
        const FbxVector4 &specularFactor,
...
public:
    ...
    void TransformTextures(const std::vector<std::function<FbxVector2(FbxVector2)>> &transforms);
